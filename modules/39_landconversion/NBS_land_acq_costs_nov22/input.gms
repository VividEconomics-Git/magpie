...
$onEmpty
table f39_calib_2(t_all,i,land39) Calibration factor for costs of pasture & forest expansion (1)
$ondelim
$if exist "./modules/39_landconversion/input/f39_calib_2.csv" $include "./modules/39_landconversion/input/f39_calib_2.csv"
$offdelim
;
$offEmpty
