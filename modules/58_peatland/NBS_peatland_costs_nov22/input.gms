...
table f58_calib_peatland_one_off(j,land58) Calibration factor for costs of peatland rewetting (one-off)
$ondelim
$if exist "./modules/58_peatland/input/f58_calib_peatland_one_off.csv" $include "./modules/58_peatland/input/f58_calib_peatland_one_off.csv"
$offdelim
;

table f58_calib_peatland_recurring(j,land58) Calibration factor for costs of peatland rewetting (recurring)
$ondelim
$if exist "./modules/58_peatland/input/f58_calib_peatland_recurring.csv" $include "./modules/58_peatland/input/f58_calib_peatland_recurring.csv"
$offdelim
;
