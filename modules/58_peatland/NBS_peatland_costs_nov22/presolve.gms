...
if (m_year(t) <= s58_fix_peatland,
	...
	i58_cost_rewet_recur(t,j) = 0;
	i58_cost_rewet_onetime(t,j) = 0;
	...
	i58_cost_rewet_onetime(t,j) = s58_cost_rewet_recur * i58_calib_peatland_one_off(j,"crop");
    i58_cost_rewet_recur(t,j) = s58_cost_rewet_onetime * i58_calib_peatland_recurring(j,"crop");
