...
parameters
 ...
 i58_cost_rewet_recur(t,j)					        Recurring costs for rewetted peatland (USD05MER per ha)
 i58_cost_rewet_onetime(t,j) 				        One-time costs for peatland restoration (USD05MER per ha)
 ...
 i58_calib_peatland_one_off(j,land58)               Calibration for peatland establishment 
 i58_calib_peatland_recurring(j,land58)             Calibration for peatland maintenance
