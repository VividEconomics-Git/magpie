...
*' Costs for peatland degradation and rewetting
 ...
 q58_peatland_cost(j2) ..
    v58_peatland_cost(j2) =e= v58_peatland_cost_annuity(j2) 
                            + sum(land58, v58_peatland_man(j2,"rewet",land58)) * sum(ct, i58_cost_rewet_recur(ct,j2))
...
q58_peatland_cost_annuity(j2) ..
    ...
    (sum(stat_rewet58, v58_expansion(j2,stat_rewet58)) * sum(ct, i58_cost_rewet_onetime(ct,j2))
