...
q32_cost_establishment(i2)..
                        v32_cost_establishment(i2)
                        =e=
            (sum(cell(i2,j2), sum((type32,ac_est),v32_land(j2,type32,ac_est)) * i32_cost_forestry_onetime(i2,j2))
              )
...
q32_cost_recur(i2) .. v32_cost_recur(i2) =e=
                    sum(cell(i2,j2), sum((type32,ac_sub),v32_land(j2,type32,ac_sub)) * i32_cost_forestry_recur(i2,j2))
                    ;
