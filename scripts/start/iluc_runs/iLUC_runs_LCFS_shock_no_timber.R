...
for (scen in c("LCFS_shock_no_timber")) { # LCFS_const2020
  ...
  if(scen == "LCFS_shock_no_timber") {
    ...
    #fg$gms$s35_hvarea <- 2 # * 2 = Timber production from natveg including age-class shifting
