...
for (scen in c("LCFS_shock_subt_50_perc")) { # LCFS_const2020
  ...
  cfg$input <- c(regional    = "WARNINGS47_rev4.73_694a3a5b_magpie.tgz",
                 ...
                 "patch_iluc_LCFS_shock_subtract_50_perc_27_09.tgz") # patch_iluc_LCFS_shock.tgz
  
  
  
  #FPS22
  
  if(scen == "LCFS_shock_subt_50_perc") {
