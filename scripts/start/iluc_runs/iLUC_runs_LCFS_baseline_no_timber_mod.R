...
for (scen in c("LCFS_base_no_timber")) { # LCFS_base
  ...
  cfg$input <- c(regional    = "WARNINGS47_rev4.73_694a3a5b_magpie.tgz",
                 ...
                 "patch_iluc_LCFS_baseline_27_09.tgz") # patch_iluc_LCFS_shock.tgz
  
  
  
  #FPS22
  
  if(scen == "LCFS_base_no_timber") { # LCFS_base_no_timber
